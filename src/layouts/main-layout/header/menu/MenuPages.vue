  ...
  <!-- <template v-for="(item, i) in MainMenuConfig" :key="i">
    <template v-if="!item.heading">
      <template v-for="(menuItem, j) in item.pages" :key="j">
        <div v-if="menuItem.heading && menuItem.role == isAdmin"  class="menu-item me-lg-1">
          <router-link 
            v-if="menuItem.route"
            class="menu-link"
            :to="menuItem.route"
    ...
    <div
      v-if="item.heading && item.role == isAdmin"
    ...
    >
      ...
      >
        <template v-for="(menuItem, j) in item.pages" :key="j">
          <div
            v-if="menuItem.sectionTitle && menuItem.role == isAdmin"
          ...
          >
            ...
            >
              <template v-for="(menuItem1, k) in menuItem.sub" :key="k">
                <div
                  v-if="menuItem1.sectionTitle && menuItem.role== isAdmin" 
                  data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                  data-kt-menu-placement="right-start"
                  class="menu-item menu-lg-down-accordion"
                >
                  <span
                    v-if="menuItem1.route && menuItem1.role == isAdmin" 
                    class="menu-link py-3"
                  ...
                  >
                    <template v-for="(menuItem2, l) in menuItem1.sub" :key="l">
                      <div class="menu-item">
                        <router-link
                          v-if="menuItem2.route && menuItem2.heading && menuItem2.role == isAdmin"
                          class="menu-link py-3"
                          active-class="active"
                          :to="menuItem2.route"
                        >
                ...
                <div v-if="menuItem1.heading && menuItem1.role == isAdmin" class="menu-item">
                  <router-link
          ...
          <div v-if="menuItem.heading && menuItem.role== isAdmin" class="menu-item">
            <router-link
