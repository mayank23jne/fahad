  ...
  >
    ...
    >
      ...
      <h3 class="text-white fw-semobold px-9 mt-10 mb-6">
        {{$t('notifications')}}
         <span class="fs-8 opacity-75 ps-3">{{ notifi.length }}</span> 
      </h3>
      <!--end::Title-->
    ...
    <!-- <div class="tab-content"> -->
      ...
      <!-- <div class="tab-pane fade" id="kt_topbar_notifications_1" role="tabpanel"> -->
        ...
        <div class="scroll-y mh-325px my-5 px-8">
          <template v-for="(item, index) in notifi" :key="index">
            <!--begin::Item-->
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="symbol symbol-35px me-4">
                  <span class="bg-light-primary symbol-label">
                    <span
                      class="svg-icon-primary svg-icon svg-icon-2"
                    >
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      ApiService.get("all_notifcation?id=" + localStorage.getItem("logged_user_id"))
      .then(({ data }) => {
        data.forEach((val) => {
          notifi.push({
            title: "تمت اضافة مهمة جديدة",
            date: val.created_at,
          });
        });
      });
