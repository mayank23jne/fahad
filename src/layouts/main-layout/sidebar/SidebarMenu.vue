    ...
    >
      ...
      > 
        <template v-for="(item, i) in MainMenuConfig" :key="i">
          <div v-if="item.heading && item.role == isAdmin" class="menu-item pt-5">
          ...
          <template v-for="(menuItem, j) in item.pages" :key="j">
            <template v-if="menuItem.heading && menuItem.role == isAdmin">
              <div class="menu-item" >
                <router-link
                  v-if="menuItem.route"
                  class="menu-link"
            ...
            <div
              v-if="menuItem.sectionTitle && menuItem.route && menuItem.role == isAdmin"
            ...
            >
              ...
              >
                <template v-for="(item2, k) in menuItem.sub" :key="k">
                  <div v-if="item2.heading && item2.role==isAdmin" class="menu-item">
