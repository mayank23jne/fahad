<template>
    <div
      class="modal fade"
      id="kt_modal_add_inspectiontype"
      ref="addInspectionTypeModalRef"
      tabindex="-1"
      aria-hidden="true"
    >
      <!--begin::Modal dialog-->
      <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
          ...
          <div class="modal-header" id="kt_modal_add_customer_header">
            <!--begin::Modal title-->
            <h2 class="fw-bold">{{translate('addinspectiontype')}}</h2>
            <!--end::Modal title-->
  
            <!--begin::Close-->
            <div
              id="kt_modal_add_inspectiontype_close"
          ...
          >
            ...
            <div class="modal-body py-10 px-lg-17">
              ...
              <div
                ...
                data-kt-scroll-dependencies="#kt_modal_add_inspectiontype_header"
                data-kt-scroll-wrappers="#kt_modal_add_inspectiontype_scroll"
            ...
            <div class="modal-footer flex-center">
              ...
              <button
                type="reset"
                id="kt_modal_add_inspectiontype_cancel"
...
import { useI18n } from "vue-i18n";
  ...
  export default defineComponent({
    ...
    setup(props, {emit}) {
      ...
      const addInspectionTypeModalRef = ref<null | HTMLElement>(null);
      ...
      const cancelprocess = () =>
       {
          hideModal(addInspectionTypeModalRef.value);
      ...
      const submit = () => {
        if (!formRef.value) {
          return;
             ...
             const array = [props.inspectiontype];
            // let a1="";
        formRef.value.validate((valid: boolean) => {
         ...
         //   let data = 30;
            loading.value = true;
            ApiService.post("createInspectionType", {
                name_en: newItem.value.name_en,
                name_ar:newItem.value.name_ar,
                user_id:user_id})
        .then(({ data }) => 
            {
              props.inspectiontype.push({
                "id": data.id,
                  "name_ar": newItem.value.name_ar,
                  "name_en": newItem.value.name_en,
                  'user_id':user_id,
