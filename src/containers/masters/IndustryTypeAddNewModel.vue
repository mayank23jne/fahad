<template>
    <div
      class="modal fade"
      id="kt_modal_add_industrytype"
      ref="addIndustryTypeModalRef"
      tabindex="-1"
      aria-hidden="true"
    >
      <!--begin::Modal dialog-->
      <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
          ...
          <div class="modal-header" id="kt_modal_add_customer_header">
            <!--begin::Modal title-->
            <h2 class="fw-bold">{{translate('addnewtype')}}</h2>
            <!--end::Modal title-->
  
            <!--begin::Close-->
            <div
              id="kt_modal_add_industrytype_close"
          ...
          >
            ...
            <div class="modal-body py-10 px-lg-17">
              ...
              <div
                ...
                data-kt-scroll-dependencies="#kt_modal_add_industrytype_header"
                data-kt-scroll-wrappers="#kt_modal_add_industrytype_scroll"
            ...
            <div class="modal-footer flex-center">
              ...
              <button
                type="reset"
                id="kt_modal_add_industrytype_cancel"
...
import { useI18n } from "vue-i18n";
  ...
  export default defineComponent({
    ...
    setup(props, {emit}) {
      ...
      const addIndustryTypeModalRef = ref<null | HTMLElement>(null);
      ...
      const cancelprocess = () =>
       {
          hideModal(addIndustryTypeModalRef.value);
      ...
      const submit = () => {
        if (!formRef.value) {
          return;
             ...
             const array = [props.industrytype];
            // let a1="";
