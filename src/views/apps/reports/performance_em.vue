...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
        title.value="تقرير اداء موظفي  الطوارئ :";
         return ApiService.get("userReportsAnswer/اماكن")
      .then(({ data }) => {
        //setAuth(data);
   ...
   const exportexcel=()=>{
    window.open('https://forms.innovativeideasbox.com/API/api/exportUserReportsAnswer/اماكن', '_blank');
