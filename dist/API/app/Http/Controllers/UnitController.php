...
class UnitController extends Controller
{
    function showUnits()
    {
        ...
        foreach ($units as $unit) {
            ...
            // $data['building_number'] = $unit->building_number . ' - ' . $unit->unit_number . ' - ' . $unitType->type . ' - ' . $unit->nationality;
             $data['building_number'] = $unit->building_number;
            $data['building_name'] = $unit->building_name;
            $data['representative'] = $unit->representative;
    ...
    function store(Request $request)
    {
        ...
        $unit->building_name = $request->bulding_name;
